...
struct {
  ...
  {{0x32, 0xF9, 0x2F, 0xD9}, 'M'},
  {{0xC2, 0xE6, 0x26, 0xD9}, 'E'},
  {{0x72, 0xC6, 0x1D, 0xD9}, 'C'},
  {{0xF2, 0x94, 0x3E, 0xD9}, 'L'},
  {{0x42, 0x90, 0x43, 0xD9}, 'A'},
  {{0x02, 0x43, 0x37, 0xD9}, 'R'}
};
...
void stepperRotateReverse() {
  ...
  digitalWrite(dirPin, LOW);  // 设置反转方向
  bool validLimitSwitchHit = false;
